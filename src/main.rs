    ...
    if key != *last {
        ...
        *debounce = -1;
        ...
        match key {
            ...
            _ => {
                led_color = Some((8, 4, 0));
            },
        };
        if let Some((r,g,b)) = led_color {
            led::blink(&mut board.led, r, g, b, 100)?;
        }
    }
    Ok(())
}
...
fn main() -> Result<()> {
    ...
    led::blink(&mut board.led, 10, 10, 0, 100)?;
